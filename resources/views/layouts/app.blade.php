...
<head>
    ...
    <title>@yield('title', 'MAMAN SUHERMAN')</title>
...
<body class="font-sans antialiased bg-gray-100">
    ...
    <header class="bg-blue-500 text-white py-4">
        <div class="container mx-auto flex justify-between items-center px-4 max-w-screen-xl">
            <h1 class="text-2xl font-bold">MAMAN SUHERMAN</h1>
    ...
    <footer class="bg-purple-800 text-white py-4">
        <div class="container mx-auto text-center px-4 max-w-screen-xl">
            <p>&copy; 2024 Created by <u><a href="https://www.instagram.com/AFAH/" class="hover:text-blue-400">ahmadfauzanarifhakim.</a></u></p>
        </div>
    </footer>
