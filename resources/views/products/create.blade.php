...
@section('content')
<button class="px-4 py-2 bg-blue-500 text-white rounded" ><a href="/product_categories">Create Categories</a></button>
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded">Save Product</button>
        </div>
    </form>
</div>
@endsection
