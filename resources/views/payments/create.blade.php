...
<div class="container mx-auto mt-10 p-6 bg-white rounded-lg shadow-lg">
    <h1 class="text-3xl font-bold mb-4 text-center text-blue-500">Payment</h1>
    ...
    <form action="{{ route('payments.store') }}" method="POST" class="space-y-6">
        ...
        <div class="text-center">
            <button type="submit" class="px-6 py-3 bg-blue-500 text-white font-bold rounded-md hover:bg-gray-600">Save Payment</button>
        </div>
    </form>
</div>
@endsection
